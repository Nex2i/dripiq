  ...
  fastify.route({
    ...
    handler: async (
      ...
      try {
        ...
        reply.send({ message: 'Profile updated', user: { id: updated.id, email: updated.email, name: updated.name } })
      } catch (error: any) {
  ...
  fastify.route({
    ...
    handler: async (
      ...
      try {
        ...
        reply.send({ message: 'User updated', user: { id: updated.id, email: updated.email, name: updated.name } })
      } catch (error: any) {
