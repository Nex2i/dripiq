...
export async function seedRoles() {
  ...
  try {
    ...
    const permissionsData = [
      ...
      { name: 'campaigns:read', description: 'View campaigns', resource: 'campaigns', action: 'read' },
      ...
      { name: 'campaigns:manage', description: 'Full campaign management', resource: 'campaigns', action: 'manage' },
      ...
      { name: 'leads:manage', description: 'Full lead management', resource: 'leads', action: 'manage' },
    ...
    const adminRole = await RoleService.createRole({
      name: 'Admin',
      description: 'Full access to all system features including user management, campaign oversight, and system configuration'
    });
