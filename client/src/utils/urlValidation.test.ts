...
describe('UrlValidator', () => {
  describe('isValidUrl', () => {
    ...
    it('should return true for valid HTTPS URLs', () => {
      ...
      expect(UrlValidator.isValidUrl('https://calendly.com/john-doe')).toBe(
        true,
      )
      expect(UrlValidator.isValidUrl('https://cal.com/jane-smith/30min')).toBe(
        true,
      )
    })
  ...
  describe('isCommonCalendarService', () => {
    it('should return true for known calendar services', () => {
      expect(
        UrlValidator.isCommonCalendarService('https://calendly.com/john'),
      ).toBe(true)
      expect(UrlValidator.isCommonCalendarService('https://cal.com/jane')).toBe(
        true,
      )
      expect(
        UrlValidator.isCommonCalendarService(
          'https://acuityscheduling.com/schedule.php',
        ),
      ).toBe(true)
      expect(
        UrlValidator.isCommonCalendarService('https://youcanbook.me/service'),
      ).toBe(true)
      expect(
        UrlValidator.isCommonCalendarService(
    ...
    it('should return true for subdomains of known services', () => {
      expect(
        UrlValidator.isCommonCalendarService('https://app.calendly.com/john'),
      ).toBe(true)
      expect(
        UrlValidator.isCommonCalendarService(
          'https://booking.acuityscheduling.com/schedule',
        ),
      ).toBe(true)
    })
    ...
    it('should return false for unknown services', () => {
      expect(
        UrlValidator.isCommonCalendarService('https://example.com/calendar'),
      ).toBe(false)
      expect(
        UrlValidator.isCommonCalendarService('https://unknown-service.com'),
      ).toBe(false)
    })
  ...
  describe('integration scenarios', () => {
    it('should handle a complete user flow - initial empty, add URL, validate', () => {
      ...
      result = UrlValidator.validateCalendarLinkStrict(
    ...
    it('should handle calendar service detection for user guidance', () => {
      ...
      expect(UrlValidator.isCommonCalendarService(validButUnknownUrl)).toBe(
        false,
      )
    })
  })
