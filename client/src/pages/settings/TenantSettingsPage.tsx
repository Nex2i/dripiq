    ...
    <div className="space-y-6">
            ...
            <div className="sm:col-span-4">
              ...
              <div className="mt-1 flex rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="input-field flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-l-0"
      ...
      <div className="flex justify-end">
        <button
          onClick={handleSave}
          disabled={isSaving}
          className="btn-primary ml-3 inline-flex justify-center py-2 px-4 text-sm font-medium rounded-md disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isSaving ? (
            <>
