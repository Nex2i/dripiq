...
export default function Login() {
  ...
  return (
          <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-sky-50 to-blue-50 py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            ...
            <button
              ...
              className="font-medium underline bg-transparent border-none cursor-pointer hover:opacity-80 transition-opacity"
              style={{ color: '#4361EE' }}
            >
              Sign up for free
            </button>
